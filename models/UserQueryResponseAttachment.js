...
module.exports = (sequelize) => {
  class UserQueryResponseAttachment extends Model {
  ...
  UserQueryResponseAttachment.init(
    {
      token: {
      ...
      type: {
        type: DataTypes.ENUM('image', 'pdf', 'video', 'music'),
      },
      description: {
        type: DataTypes.STRING,
        defaultValue: null,
      ...
      status: {
        type: DataTypes.ENUM('active', 'disable', 'blocked'),
      },
      updated_by: {
        type: DataTypes.STRING,
        defaultValue: null,
    ...
    {
      sequelize,
      modelName: 'UserQueryResponseAttachment',
      tableName: 'user_query_response_attachments',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (attachment) => {
      //     attachment.token = CreateToken('userQueryResponseAttachment');
      //     attachment.slug = CreateSlug(attachment.title || '');
  ...
  return UserQueryResponseAttachment;
};
