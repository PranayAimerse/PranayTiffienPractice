...
module.exports = (sequelize, DataTypes) => {
  class UserBusiness extends Sequelize.Model {
  ...
  UserBusiness.init(
    ...
    },
    {
      ...
      tableName: 'userbusinesses',
      // hooks: {
      //   afterCreate: async (userBusiness) => {
      //     // Create token and slug after saving
      //     userBusiness.token = CreateToken('userBusiness');
      //     userBusiness.slug = slugify(userBusiness.name, { lower: true });
