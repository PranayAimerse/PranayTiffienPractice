...
module.exports = (sequelize) => {
  class UserSubscriptionDeliverySchedule extends Model {
  ...
  UserSubscriptionDeliverySchedule.init(
    {
      token: {
      ...
      status: {
        type: DataTypes.ENUM('upcoming', 'active', 'completed', 'disable'),
      },
      update_by: {
        type: DataTypes.STRING,
        defaultValue: null,
    ...
    {
      sequelize,
      modelName: 'UserSubscriptionDeliverySchedule',
      tableName: 'user_subscription_delivery_schedules',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (schedule) => {
      //     schedule.token = CreateToken('userSubscriptionDeliverySchedule');
      //     await schedule.save();
      //   },
      // },
    }
  ...
  return UserSubscriptionDeliverySchedule;
};
