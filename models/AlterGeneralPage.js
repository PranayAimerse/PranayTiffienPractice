...
module.exports = (sequelize) => {
  class AlterGeneralPage extends Model {
  ...
  AlterGeneralPage.init(
    ...
    {
      sequelize,
      modelName: 'AlterGeneralPage',
      tableName: 'alter_general_pages',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (page) => {
      //     page.token = CreateToken('alter_general_page');
