...
module.exports = (sequelize) => {
  class VerifyOtpHistory extends Model {
  ...
  VerifyOtpHistory.init(
    { 
      token: { type: DataTypes.STRING },
      slug: { type: DataTypes.STRING, defaultValue: null },
      user_id: { type: DataTypes.INTEGER, defaultValue: null },
      token_user: { type: DataTypes.STRING, defaultValue: null },
      user_type: { type: DataTypes.FLOAT, defaultValue: null },
      username: { type: DataTypes.FLOAT, defaultValue: null },
      otp: { type: DataTypes.FLOAT, defaultValue: null },
      for: { type: DataTypes.STRING, defaultValue: null },
      type: { 
      ...
      device_latitude: { type: DataTypes.STRING, defaultValue: null },
      device_longitude: { type: DataTypes.INTEGER, defaultValue: null },
      name_country: { type: DataTypes.INTEGER, defaultValue: null },
      name_state: { type: DataTypes.STRING },
      name_city: { type: DataTypes.STRING },
      update_by: { type: DataTypes.STRING, defaultValue: null },
      updated_user_type: { type: DataTypes.STRING, defaultValue: null },
      created_by: { type: DataTypes.STRING, defaultValue: null },
      created_user_type: { type: DataTypes.STRING, defaultValue: null },
    },
    {
      sequelize,
      modelName: 'VerifyOtpHistory',
      tableName: 'VerifyOtpHistory',
      timestamps: false, 
    }
  );

  return VerifyOtpHistory;
};
