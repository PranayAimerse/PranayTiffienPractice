...
module.exports = (sequelize) => {
  class ProductTypeItems extends Model {
    // Static method to add a new product type item
  ...
  ProductTypeItems.init(
    ...
    {
      sequelize,
      modelName: 'ProductTypeItems',
      tableName: 'product_type_items',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (productTypeItem) => {
      //     productTypeItem.token = CreateToken('ProductTypeItems');
      //     productTypeItem.slug = CreateSlug(productTypeItem.title);
      //     await productTypeItem.save();
      //   },
      // },
    }
  );
