...
module.exports = (sequelize) => {
  class UserExecutiveLog extends Model {
  ...
  UserExecutiveLog.init(
    ...
    },
    {
      sequelize,
      timestamps: false,
      modelName: 'UserExecutiveLog',
      tableName: 'userexecutivelogs',
      // hooks: {
      //   afterCreate: async (log) => {
      //     log.token = CreateToken('userExecutiveLog');
      //     log.slug = CreateSlug(log.type || 'log');
      //     await log.save();
      //   },
      // },
    }
