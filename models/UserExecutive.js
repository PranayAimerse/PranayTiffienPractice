  ...
  UserExecutive.init(
    {
      ...
      url_profile: { type: DataTypes.STRING, defaultValue: null },
      name: { type: DataTypes.STRING },
      gender: { type: DataTypes.ENUM('male', 'female') },
      dob: { type: DataTypes.STRING },
      order_by: { type: DataTypes.STRING },
      user_Type: { type: DataTypes.STRING },
      status: { type: DataTypes.ENUM('active', 'disable', 'block', 'pending') },
      email: { type: DataTypes.STRING },
      email_verified: { type: DataTypes.ENUM('yes', 'no') },
      email_verifiedAt: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
      mobile: { type: DataTypes.STRING },
      mobile_verifiedAt: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
      mobile_code: { type: DataTypes.STRING },
      name_country: { type: DataTypes.STRING, defaultValue: null },
      name_state: { type: DataTypes.STRING, defaultValue: null },
      name_city: { type: DataTypes.STRING, defaultValue: null },
      pincode: { type: DataTypes.STRING, defaultValue: null },
      address: { type: DataTypes.STRING },
      landmark: { type: DataTypes.STRING, defaultValue: null },
      device_token: { type: DataTypes.STRING, defaultValue: null },
      device_latiitude: { type: DataTypes.STRING, defaultValue: null },
      device_longitude: { type: DataTypes.STRING, defaultValue: null },
      password: { type: DataTypes.STRING },
      remember_token: { type: DataTypes.STRING },
      updated_by: { type: DataTypes.STRING, defaultValue: null },
      updatated_user_type: { type: DataTypes.STRING, defaultValue: null },
      created_by: { type: DataTypes.STRING, defaultValue: null },
      created_user_type: { type: DataTypes.STRING, defaultValue: null },
    },
    {
      sequelize,
      timestamps: false,
      modelName: 'UserExecutive',
      tableName: 'userexecutives',
      // hooks: {
      //   afterCreate: async (userExecutive) => {
      //     userExecutive.token = CreateToken('userExecutive');
      //     userExecutive.slug = CreateSlug(userExecutive.name);
