...
module.exports = (sequelize) => {
  class UserExecutiveDeviceToken extends Model {
  ...
  UserExecutiveDeviceToken.init(
    {
      token: { type: DataTypes.STRING },
      slug: { type: DataTypes.STRING },
      user_id: { type: DataTypes.BIGINT.UNSIGNED },
      token_user: { type: DataTypes.STRING },
      user_Type: { type: DataTypes.STRING },
      device_type: { type: DataTypes.STRING },
      device_token: { type: DataTypes.STRING },
      device_ref_id: { type: DataTypes.STRING },
      device_info: { type: DataTypes.STRING },
      device_latitude: { type: DataTypes.FLOAT },
      device_longitude: { type: DataTypes.FLOAT },
      is_login: { type: DataTypes.ENUM('yes', 'no') },
      logout_at: { type: DataTypes.DATE, defaultValue: DataTypes.NOW },
    ...
    },
    {
      sequelize,
      timestamps: false,
      modelName: 'UserExecutiveDeviceToken',
      tableName: 'userexecutivedevicetokens',
      // hooks: {
      //   afterCreate: async (deviceToken) => {
      //     deviceToken.token = CreateToken('userExecutiveDeviceToken');
      //     deviceToken.slug = CreateSlug(deviceToken.device_token || 'deviceToken');
  ...
  return UserExecutiveDeviceToken;
};
