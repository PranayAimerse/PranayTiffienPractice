...
module.exports = (sequelize) => {
  class AlterStateDistrict extends Model {
    // Static method to create a new AlterStateDistrict
  ...
  AlterStateDistrict.init(
    ...
    {
      sequelize,
      modelName: 'AlterStateDistrict',
      tableName: 'alter_state_districts',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (district) => {
      //     district.token = CreateToken('alter_state_district');
      //     district.slug = CreateSlug(district.name);
      //     await district.save();
      //   },
      // },
    }
