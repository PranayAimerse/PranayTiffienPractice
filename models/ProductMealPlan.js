...
module.exports = (sequelize) => {
  class ProductMealPlan extends Model {
    // Static method to add a new product meal plan
  ...
  ProductMealPlan.init(
    ...
    {
      sequelize,
      modelName: 'ProductMealPlan',
      tableName: 'product_meal_plans',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (mealPlan) => {
      //     mealPlan.token = CreateToken('ProductMealPlan');
      //     mealPlan.slug = CreateSlug(mealPlan.title);
      //     await mealPlan.save();
      //   },
      // },
    }
