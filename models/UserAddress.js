...
const { CreateSlug } = require('../utils/generateSlug');
...
module.exports = (sequelize, DataTypes) => {
  ...
  Useraddress.init(
    ...
    },
    {
      ...
      timestamps: true,
      // hooks: {
      //   afterCreate: async (useraddress) => {
      //     try {
      //       useraddress.token = CreateToken('useraddress');
      //       useraddress.slug = CreateSlug(useraddress.name);
      //       await useraddress.save(); // Save the updated values
      //     } catch (error) {
      //       console.error('Error generating token or slug:', error);
      //     }
      //   },
      // },
    }
