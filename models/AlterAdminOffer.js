...
module.exports = (sequelize) => {
  class AlterAdminOffer extends Model {
    static associate(models) {
      // define associations here if necessary
    }

    static async getByLike(
      searchStr,
      keyValueSet = null,
      inKeyValueSet = null,
  ...
  AlterAdminOffer.init(
    ...
    {
      sequelize,
      modelName: "AlterAdminOffer",
      tableName: "alter_admin_offers",
      timestamps: false,
      // hooks: {
      //   afterCreate: async (offer) => {
      //     offer.token = CreateToken("alterAdminOffer");
      //     offer.slug = CreateSlug(offer.title);
      //     await offer.save();
      //   }
      // }
    }
