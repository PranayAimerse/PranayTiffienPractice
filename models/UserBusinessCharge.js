...
module.exports = (sequelize, DataTypes) => {
  class UserBusinessCharge extends Sequelize.Model {
  ...
  UserBusinessCharge.init(
    {
      ...
      status: {
        type: DataTypes.ENUM("incomplete", "pending", "approved", "blocked"),
        allowNull: true,
      },
      updated_user_type: {
        type: DataTypes.STRING,
    ...
    },
    {
      sequelize,
      timestamps: false,
      modelName: "UserBusinessCharge",
      tableName: "userbusinesscharges",
      // hooks: {
      //   afterCreate: async (userBusinessCharge) => {
      //     // Create token after saving the userBusinessCharge instance
      //     userBusinessCharge.token = CreateToken("userBusinessCharge");
      //     await userBusinessCharge.save();
      //   },
      // },
    }
  );

  return UserBusinessCharge;
};
