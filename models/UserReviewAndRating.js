...
module.exports = (sequelize) => {
  class UserReviewAndRating extends Model {
  ...
  UserReviewAndRating.init(
    ...
    {
      sequelize,
      modelName: 'UserReviewAndRating',
      tableName: 'user_review_and_ratings',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (review) => {
      //     review.token = CreateToken('UserReviewAndRating');
      //     await review.save();
      //   },
      // },
    }
