...
module.exports = (sequelize) => {
  class ProductType extends Model {
    // Static method to add a new product type
  ...
  ProductType.init(
    ...
    },
    {
      ...
      timestamps: false,
      // hooks: {
      //   afterCreate: async (productType) => {
      //     productType.token = CreateToken('ProductType');
      //     productType.slug = CreateSlug(productType.title);
