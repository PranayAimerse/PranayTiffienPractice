...
module.exports = (sequelize) => {
  class AlterAdminSetting extends Model {
  ...
  AlterAdminSetting.init(
    ...
    {
      sequelize,
      modelName: 'AlterAdminSetting',
      tableName: 'alter_admin_settings',
      timestamps: false,
      // hooks: {
      //   afterCreate: async (setting) => {
      //     setting.token = CreateToken('alterAdminSetting');
      //     setting.slug = CreateSlug(setting.title);
      //     await setting.save();
      //   },
      // },
    }
